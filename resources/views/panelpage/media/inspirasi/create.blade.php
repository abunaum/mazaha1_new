...
@section('content')
    ...
    <section class="section dashboard">
        <div class="row">
            <div class="col-lg-8">
                <form method="post" action="{{ route('inspirasi-alumni-tambah-progress') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <button type="submit" class="btn btn-primary">Buat Inspirasi</button>
                </form>
            </div>
        </div>
    </section>
